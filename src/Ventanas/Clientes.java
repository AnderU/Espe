...
public class Clientes {
	...
	private void initialize() {
		frmClnt = new JFrame();
		frmClnt.setIconImage(Toolkit.getDefaultToolkit().getImage(Clientes.class.getResource("/Imagenes/Animals-Fish-icon.png")));
...
//****************** PANEL DATOS ************************************	
		...
		frmClnt.getContentPane().add(panel_datos);
...
//****************** BORRAR ************************************	
	...
	btnBorrar.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) 
		{
			int result=JOptionPane.showConfirmDialog(frmClnt, "El cliente seleccionado se borrará de la base de datos. ¿Estás segur@?", "¡Atención!",JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE);
...
//****************** PANEL BUSCAR ************************************	
	...
	frmClnt.getContentPane().add(panel_buscar);
